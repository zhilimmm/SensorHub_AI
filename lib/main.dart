...
import 'screens/home_tab.dart'; // We import your new file here!
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> pages = [
      const HomeTab(), // 👇 THIS IS YOUR NEW FILE 👇
      ...
      const Center(child: Text('🎛️ Manual Controls', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFF064E3B)))),       
      const DataTab(),        
      const Center(child: Text('⚙️ System Settings', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFF064E3B)))),      
    ];
